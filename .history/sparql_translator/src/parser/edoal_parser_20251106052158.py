...
class EdoalParser:
    ...
    def _parse_entity(self, element: ET.Element) -> Optional[EDOALEntity]:
        ...
        # Container-like entities without rdf:about
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        parser = EdoalParser("/Users/masa669/Documents/linkeddata/sparql-translator-complex-alignment-master/examples/AgronomicTaxon-Agrovoc.edoal.xml")
