...
/** A really simple utility that loads an alignment and prints it.
 * A basic class for ontology alignment processing.
 *   Command synopsis is as follows:
 *
 *   <pre>
 *   java fr.inrialpes.exmo.align.cli.ParserPrinter [options] input [output]
 *   </pre>
 *
 ...
 *	--threshold=threshold -t threshold      Trim the alignment with regard to threshold
...
public class ParserPrinter extends CommonCLI {
	...
	public void run(String[] args) throws Exception {
		...
		try {
			...
			System.out.println("Alignment structure parsed");
			// Set output file
			OutputStream stream;
			...
			/*******line added*************/
			System.out.println("Nb cells" + result.nbCells());
			...
			if ( rendererClass == null ) renderer = new RDFRendererVisitor( writer );
				...
				try {
					System.out.println("Renderer Class: " + rendererClass);
